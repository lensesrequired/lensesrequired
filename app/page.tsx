          ...
          <Col md={4} className="px-2 text-center">
            ...
            <h6>
              {badges.map(({ Icon, link, text }) => (
                <Badge bg="light" text="dark" className="m-1">
                  <a href={link}>
            ...
            <Row>
              <Col lg>
                ...
                <div>
                  <span>
                    <strong>
                      Senior Software Development Engineer, GoDaddy, Hiawatha,
                      IA — Jun 2018-Present
                    </strong>
                  </span>
                  <ul>
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      Provide assistance for college level mathematic and
                ...
                <div>
                  <span>
                    <strong>
                      Mathematics Research, Coe College, Cedar Rapids, IA —
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      Implemented using Google Forms, Spreadsheets, and
                      Calendars with Google Apps Script to unify submitted
                      content
                    </li>
                  </ul>
                </div>
              ...
              <Col lg>
                ...
                <div className="mb-3">
                  ...
                  <div>
                    Activities: Computer Science Club (President), Math Club
                    (Vice President)
                  </div>
                </div>
              </Col>
